...
stopifnot(identical(
    mill:::merge_font_styles(
               "\\textit{Mycoplasma }\\textit{gallisepticum}\\textit{ / Mycoplasma }\\textit{synoviae}"),
    "\\textit{Mycoplasma gallisepticum / Mycoplasma synoviae}"))

stopifnot(identical(
    mill:::merge_font_styles(
               "\\textit{Mycoplasma }\\textit{gallisepticum}\\textit{/}\\textit{synoviae} some more text."),
